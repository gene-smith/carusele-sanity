...
const loadProps = receivedProps$ => receivedProps$.pipe((0, _operators.distinctUntilChanged)((prev, next) => prev.id === next.id), (0, _operators.switchMap)(receivedProps => (0, _rxjs.concat)((0, _rxjs.of)(_objectSpread({}, receivedProps, {
  referringDocuments: [],
  isLoading: true
...
const WithReferringDocuments = (0, _reactPropsStream.withPropsStream)(loadProps, (_ref) => {
