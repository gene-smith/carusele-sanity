...
class PanesSplitController extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "renderSplitPane", (pane1, pane2) => {
      ...
      const collapsedWidth = this.props.collapsedWidth;
      const isResizing = this.state.isResizing;
      const size = isCollapsed ? collapsedWidth : undefined;
      return _react.default.createElement("div", {
        className: `
          ${_SplitController.default.vertical}
          ${isResizing ? _SplitController.default.splitWrapperResizing : _SplitController.default.splitWrapper}
          ${pane2 ? '' : _SplitController.default.singleWrapper}
      ...
      }, pane1, pane2 || _react.default.createElement("div", {
        style: {
          display: 'none'
        }
      })));
