...
<span class="cline-any cline-no">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const fromStream = require('./importFromStream')
...
&nbsp;
  <span class="missing-if-branch" title="else path not taken" >E</span>if (Array.isArray(input)) {
    return fromArray(input, options, importers)
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (typeof input === 'string') {</span>
<span class="cstat-no" title="statement not covered" >    return fromFolder(input, options, importers)</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  throw new Error('Stream does not seem to be a readable stream, an array or a path to a directory')</span>
}
&nbsp;</pre></td></tr>
</table></pre>
