...
<html lang="en">
<head>
    <title>Code coverage report for src/util/getJsonStreamer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">All files</a> / <a href="index.html">src/util</a> getJsonStreamer.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const split = require('split2')
...
&nbsp;
  function getErrorMessage(err) {
    const suffix =
      lineNumber === 1 ? <span class="branch-0 cbranch-no" title="branch not covered" >'\n\nMake sure this is valid ndjson (one JSON-document *per line*)' </span>: ''
&nbsp;
