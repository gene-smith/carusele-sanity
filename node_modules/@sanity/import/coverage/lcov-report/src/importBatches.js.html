...
<html lang="en">
<head>
    <title>Code coverage report for src/importBatches.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> importBatches.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const pMap = require('p-map')
...
function importBatch(options, progress, batch) {
  ...
  const maxRetries = operation === 'create' ? 1 : <span class="branch-1 cbranch-no" title="branch not covered" >3</span>
&nbsp;
