...
<html lang="en">
<head>
    <title>Code coverage report for src/assignDocumentId.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">All files</a> / <a href="index.html">src</a> assignDocumentId.js
    </h1>
    <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">const uuid = require('@sanity/uuid')
&nbsp;
