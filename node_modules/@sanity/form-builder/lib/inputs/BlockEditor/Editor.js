...
function scrollIntoView(node) {
  ...
  const element = (0, _slateReact.findDOMNode)(node); // eslint-disable-line react/no-find-dom-node
...
class Editor extends _react.default.Component {
  constructor(_props) {
    ...
    _defineProperty(this, "handleShowBlockDragMarker", (pos, node) => {
      ...
      const editorDOMNode = _reactDom.default.findDOMNode(this.getEditor());
    ...
    _defineProperty(this, "handlePaste", (event, editor, next) => {
      ...
      const onPaste = this.props.onPaste || _onPaste.default;
    ...
    _defineProperty(this, "handleToggleFullscreen", (event, editor, next) => {
      ...
      const isEsc = (0, _isHotkey.isKeyHotkey)('esc');
    ...
    _defineProperty(this, "renderNode", props => {
      ...
      let ObjectClass = _BlockObject.default;
      let ObjectType = blockContentFeatures.types.blockObjects.find(memberType => memberType.name === node.type);
    ...
    _defineProperty(this, "renderMark", props => {
      ...
      const CustomComponent = decorator && decorator.blockEditor && decorator.blockEditor.render ? decorator.blockEditor.render : null;
  ...
  componentDidUpdate(prevProps) {
    ...
    const focusPath = this.props.focusPath;

    if (!focusPath || focusPath.length === 0) {
      return;
    }

    const focusPathChanged = !(0, _isEqual2.default)(prevProps.focusPath, focusPath);
  ...
  trackFocusPath() {
    ...
    const focusPathIsSingleBlock = editorValue.focusBlock && (0, _isEqual2.default)(focusPath, [{
  ...
  render() {
    ...
    const classNames = [_Editor.default.root, (renderBlockActions || hasMarkers) && _Editor.default.hasBlockExtras, fullscreen ? _Editor.default.fullscreen : null].filter(Boolean);
