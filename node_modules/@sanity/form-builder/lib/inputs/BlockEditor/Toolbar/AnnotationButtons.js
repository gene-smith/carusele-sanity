...
class AnnotationButtons extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "handleClick", (item, originalSelection) => {
      ...
      const key = (0, _blockTools.randomKey)(12);
    ...
    _defineProperty(this, "renderAnnotationButton", item => {
      ...
      const onAction = originalSelection => {
  ...
  getItems() {
    ...
    const disabled = userIsWritingText || editor.query('hasSelectionWithText') === false || inlines.some(inline => inline.type !== 'span');
