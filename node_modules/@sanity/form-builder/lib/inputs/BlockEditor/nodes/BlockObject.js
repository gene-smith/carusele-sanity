...
class BlockObject extends _react.default.Component {
  constructor() {
    ...
    event => {
      ...
      const targetNode = (0, _slateReact.findNode)(targetDOMNode, editor);
      ...
      const block = targetNode.object === 'block' ? targetNode : editor.value.document.getClosestBlock(targetNode.key); // If no or same block reset and return
      ...
      const blockDOMNode = (0, _slateReact.findDOMNode)(block);
    ...
    _defineProperty(this, "handleRemoveValue", () => {
  ...
  render() {
    ...
    if (!validTypes.includes(valueType)) {
      return _react.default.createElement("div", attributes, _react.default.createElement(_InvalidValueInput.default, {
    ...
    const classname = (0, _classnames.default)([_BlockObject.default.root, editor.value.selection.focus.isInNode(node) && _BlockObject.default.focused, isSelected && _BlockObject.default.selected, errors.length > 0 && _BlockObject.default.hasErrors, isDragging && _BlockObject.default.isDragging]);
