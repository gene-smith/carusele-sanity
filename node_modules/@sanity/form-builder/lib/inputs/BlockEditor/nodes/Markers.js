...
class Markers extends _react.default.Component {
  ...
  render() {
    ...
    }, validationMarkers.length > 0 && _react.default.createElement("div", {
    ...
    })), customMarkers.length > 0 && _react.default.createElement("div", {
      className: _Markers.default.markerGroup,
      onClick: this.handleCancelEvent
    }, renderCustomMarkers && renderCustomMarkers(customMarkers), !renderCustomMarkers && _react.default.createElement(_blockMarkersCustomDefault.default, {
      markers: markers
    })));
  }
