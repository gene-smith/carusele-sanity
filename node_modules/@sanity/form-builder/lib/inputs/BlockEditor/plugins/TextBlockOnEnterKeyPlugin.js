...
function TextBlockOnEnterKeyPlugin() {
  ...
  return {
    onKeyDown(event, editor, next) {
      ...
      const isTextBlock = value.blocks.some(block => block.data.get('style'));
      const isListNode = value.blocks.some(block => block.data.get('listItem'));
      ...
      const blocKey = (0, _blockTools.randomKey)(12);
