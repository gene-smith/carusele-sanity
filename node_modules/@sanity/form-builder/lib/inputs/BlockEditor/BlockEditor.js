...
class BlockEditor extends _react.default.PureComponent {
  constructor() {
    ...
    _defineProperty(this, "checkScrollHeight", () => {
      if (this.scrollContainer && this.scrollContainer.current && this.editorWrapper.current) {
        const preventScroll = this.scrollContainer.current.offsetHeight < this.editorWrapper.current.offsetHeight;
  ...
  renderBlockEditor() {
    ...
    const scrollContainerClassNames = [_BlockEditor.default.scrollContainer, renderBlockActions || hasMarkers ? _BlockEditor.default.hasBlockExtras : null].filter(Boolean).join(' ');
