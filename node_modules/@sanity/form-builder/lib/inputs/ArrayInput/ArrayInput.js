  ...
  constructor() {
    ...
    _defineProperty(this, "renderList", () => {
      ...
      return _react.default.createElement(List, _extends({
        ...
        const isChildMarker = marker => (0, _paths.startsWith)([index], marker.path) || (0, _paths.startsWith)([{
          _key: item && item._key
        }], marker.path);
    ...
    _defineProperty(this, "handleRemoveNonObjectValues", () => {
      ...
      const patches = nonObjects.map(index => (0, _PatchEvent.unset)([index]));
      onChange(_PatchEvent.PatchEvent.from(...patches));
    });
