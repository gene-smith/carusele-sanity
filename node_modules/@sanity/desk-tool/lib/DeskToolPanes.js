...
class DeskToolPanes extends _react.default.Component {
  constructor() {
    ...
    _defineProperty(this, "handleAutoCollapse", function (windowWidth, paneWantExpand) {
      let userCollapsedPanes = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      ...
      const totalMinSize = (0, _sumBy2.default)(panes, pane => getPaneMinSize(pane));
  ...
  componentDidUpdate(prevProps) {
    ...
    let paneToForceExpand; // Expand new panes
